                                    ...
                                    {NAV_ITEMS.map((item) => (
                                        <div key={item.key} className="mobile-menu-item">
                                            <Link href={item.href} onClick={closeMobileMenu}>
                                                <button type="button" className="block w-full rounded-xl px-3 py-3 font-sans text-2xl font-light tracking-tight text-primary/70 transition-colors duration-200 ltr:text-left rtl:text-right">
                                                    {t(item.key)}
                                                </button>
                                            </Link>
                                        </div>
