                            ...
                            <div className="space-y-6 py-8">
                                    ...
                                    {NAV_ITEMS.map((item) => (
                                        <div key={item.key} className="mobile-menu-item">
                                            <Link href={item.href} onClick={closeMobileMenu}>
                                                <button type="button" className="block w-full rounded-xl px-3 py-3 font-sans text-2xl font-light tracking-tight text-primary/70 transition-colors duration-200 ltr:text-left rtl:text-right ltr:group-hover:translate-x-1.5 rtl:group-hover:-translate-x-1.5">
                                                    {t(item.key)}
                                                </button>
                                            </Link>
                                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="mobile-menu-item flex items-center justify-between ">
                                        <span className="font-mono text-xs uppercase tracking-[0.25em] text-muted-foreground/70">
                                            {t('language')}
                                        </span>
                                        <LanguageChanger />
                                    </div>
