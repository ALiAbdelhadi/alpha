...
export function EstimatorSection() {
  ...
  return (
    <section
      ...
      id="estimator"
      ref={sectionRef}
      className="flex w-full items-center section-padding bg-foreground/[0.02]"
    >
      <Container>
            ...
            <div ref={formContainerRef} className="pt-4">
                {step === 1 && (
                    <div className="space-y-6">
                        <h3 className="text-2xl font-medium text-primary mb-6">{t("step1.question")}</h3>
                            ...
                            {['ecommerce', 'corporate', 'custom', 'performance'].map((type) => (
                                <button
                                    ...
                                    className={`relative p-5 rounded-xl border text-start transition-all duration-300 ${
                                        ...
                                        : 'border-border/50 bg-foreground/[0.02] hover:border-foreground/20 hover:bg-foreground/[0.04]'
                                    }`}
                                >
                ...
                {step === 2 && (
                    <div className="space-y-6">
                        <h3 className="text-2xl font-medium text-primary mb-6">{t("step2.question")}</h3>
                ...
                {step === 3 && (
                    <div className="space-y-6">
                        <h3 className="text-2xl font-medium text-primary mb-6">{t("step3.question")}</h3>
                        <div className="grid grid-cols-1 flex-col gap-4">
                ...
                {step === 4 && (
                    <div className="space-y-8 py-4 text-center">
                        ...
                        <div className="p-8 rounded-2xl bg-foreground/[0.03] border border-border/50 max-w-lg mx-auto">
                            <p className="mono-uppercase text-primary/50 text-sm mb-2">
                                {t("results.investment")}
                            </p>
                            <p className="text-5xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-600 mb-6 drop-shadow-sm">
                                {selections.type && calculateEstimate()}{!selections.type && (locale === 'ar' ? "???? ج.م" : "???? EGP")}
                            </p>
                            ...
                            <MagneticButton 
                                ...
                                onClick={() => window.location.href = `mailto:hello@anthupic.com?subject=Project Inquiry: ${selections.type} budget ${selections.budget}`}
                            >
