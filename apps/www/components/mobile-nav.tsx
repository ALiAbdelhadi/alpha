...
import { AltruvexLogo } from "@/components/altruvex-logo"
          ...
          <div className="flex flex-1 flex-col gap-4">
            {navItems.map((item) => (
              <button
                ...
                className={`group relative rounded-lg px-4 py-3 text-left font-sans text-base font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-foreground/50 ${currentSection === item.sectionId
