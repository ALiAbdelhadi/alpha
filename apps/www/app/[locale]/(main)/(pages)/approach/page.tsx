                ...
                <div ref={demoRef} className="rounded-lg border border-foreground/25 p-8 md:p-12">
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="rounded-full border border-foreground/25 bg-foreground/5 px-4 py-2 mono small text-primary transition-colors duration-300 hover:bg-foreground/10"
                        >
                            {isRTL ? "EN" : "AR"}
                        </button>
                    </div>
                ...
                <div className="max-w-3xl">
                    ...
                    <div ref={ctaRef}>
                        <a
                            ...
                            className="inline-flex items-center gap-2 mono body-lg text-primary transition-colors duration-300 hover:text-primary/70"
                        >
                            {t("cta")}
