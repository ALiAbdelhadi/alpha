  ...
  return (
    <div className="mt-8 rounded-sm border border-foreground/20 bg-foreground/5 p-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-primary/40 mb-1">
            {t("pdf.label")}
          </p>
    ...
    <div>
      ...
      <div className="mb-8 p-6 rounded-sm border border-foreground/20 bg-foreground/5 text-start flex gap-4 items-start">
        ...
        <div>
          ...
          <p className="body text-primary/80 leading-relaxed">
            {t("results.rangeCta")}
          </p>
        </div>
      </div>
      <p className="small text-primary/50 mb-8 text-center">
      ...
      <div className="space-y-4">
        {options.map((option, i) => (
          ...
          >
            <div
              className={cn(
                "w-10 h-10 rounded-sm flex items-center justify-center shrink-0 font-mono text-sm",
                selected === option
                  ? "bg-foreground/20 text-primary"
                  : "bg-foreground/10 text-primary/70",
              )}
