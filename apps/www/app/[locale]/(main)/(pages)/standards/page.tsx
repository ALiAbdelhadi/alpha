                        ...
                        {[
                            ...
                            >
                                ...
                                {value ? (
                                    ...
                                    >
                                        {value}
                                        <span className="font-mono text-xs text-primary/35 uppercase tracking-[0.15em] ml-2">
                                            {sub}
                                        </span>
                                    </p>
                                ) : (
                                    <p className="text-sm text-primary/60 leading-relaxed">{sub}</p>
                                )}
                            </div>
                        ))}
                    </div>
            ...
            <Container>
                ...
                <div>
                    {categories.map((cat, i) => (
                        ...
                        >
                            <span className="font-mono text-xs text-primary/20 tracking-[0.2em] pt-2">
                                            ...
                                            <div className="space-y-3">
                                                {items.map((item: string, j: number) => (
                                                    <div key={j} className="flex items-start gap-3">
                                                        ...
                                                        <p className="text-sm text-primary/60 leading-relaxed">{item}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
        ...
        <section className="section-padding border-t border-foreground/8">
            <Container>
                <div className="max-w-3xl">
                    ...
                    <p ref={descRef} className="text-base text-primary/60 leading-relaxed">
                        {t("description")}
                    </p>
                </div>
            </Container>
