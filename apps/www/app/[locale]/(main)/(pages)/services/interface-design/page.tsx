...
function HeroSection() {
  ...
  return (
    <section
      className="webDesign-watermark relative flex w-full flex-col justify-end section-padding pb-24 overflow-hidden"
          ...
          {showcaseItems.map((item, i) => (
            ...
            >
              ...
              <div className="relative z-10 flex items-start justify-between">
                <span className="font-mono text-xs text-muted-foreground/70 tracking-[0.2em]">
                  {item.number}
                </span>
                <span className="font-mono text-sm text-muted-foreground/70 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5">
                  ↗
                </span>
              </div>
...
function FeaturesSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative section-padding border-t border-foreground/8"
    >
                ...
                {isHero ? (
                  ...
                  <div className="relative z-10 flex items-center gap-6 md:gap-8">
                    ...
                    <div className="feat-text-inner flex-1 min-w-0">
                      ...
                      <p className="feat-desc mt-2.5">{feature.description}</p>
                    </div>
                  </div>
                )}
              </div>
    ...
    >
      <Container>
        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-4">
          ...
          >
            <span className="font-mono text-xs uppercase tracking-[0.25em] text-muted-foreground/70 block">
              Colors
            </span>
