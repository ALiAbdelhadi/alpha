                ...
                <div ref={titleRef} className="mb-16">
                    ...
                    <div className="flex items-end justify-between gap-8 flex-wrap">
                        ...
                        >
                            ...
                            >
                                {t("techStack.titleItalic") ?? "every tool, intentional."}
                            </span>
                        </h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4">
                    {technologies.map((tech, i) => (
                        <div
                            key={tech.name}
                            data-tech-item
                            className="group relative border-b border-r border-foreground/8 p-6 md:p-8 hover:bg-foreground/3 transition-colors duration-300 last:border-r-0 nth-[4n]:border-r-0 nth-[4n+1]:ltr:border-l-0 nth-[4n+1]:rtl:border-r-0"
                        >
                            ...
                            <span className="font-mono text-xs uppercase tracking-[0.2em] text-primary/25 mb-3 block">
                            ...
                            <div
                                aria-hidden
                                className="absolute bottom-3 ltr:right-4 rtl:left-4 font-mono text-xs text-primary/15 tracking-[0.15em]"
                            >
                    ...
                    <div className="flex items-end justify-between gap-8 flex-wrap">
                        ...
                        >
                            ...
                            <span
                                ...
                                style={{ fontFamily: "Georgia, serif", fontStyle: "italic" }}
                            >
                                {tCommon("whatWeOfferItalic") ?? "in every build."}
                            </span>
                        </h2>
...
function CtaSection() {
    const t = useTranslations("serviceDetails.development")
    const tCommon = useTranslations("serviceDetails")
    const cardRef = useReveal<HTMLDivElement>({ direction: "up", delay: 0, duration: 0.7 })
    ...
    return (
        <section className="section-padding border-t border-foreground/8">
            <Container>
                <div
                    ref={cardRef}
                    className="border border-foreground/8 rounded-sm overflow-hidden"
                >
