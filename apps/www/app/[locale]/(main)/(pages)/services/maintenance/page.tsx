                ...
                <div className="grid md:grid-cols-12 gap-4">
                    ...
                    >
                        <p className="font-mono text-xs uppercase tracking-[0.25em] text-primary/25 mb-4 block">
                            {t("stats.eyebrow") ?? "Uptime Guarantee"}
                        </p>
                        <h2
                ...
                <div ref={titleRef} className="mb-16">
                    ...
                    <div className="flex items-end justify-between gap-8 flex-wrap">
                        ...
                        >
                            ...
                            >
                                {tCommon("whatWeOfferItalic") ?? "in every plan."}
                            </span>
                        </h2>
...
function PricingSection() {
    ...
    useEffect(() => {
        ...
        cards.forEach((card, index) => {
            gsap.set(card, { opacity: 0, y: ANIM.distance.md, willChange: "transform, opacity" })
            const tween = gsap.to(card, {
                opacity: 1, y: 0,
                duration: ANIM.duration.md,
                    ...
                    <div className="flex items-end justify-between gap-8 flex-wrap">
                        ...
                        >
                            ...
                            <span
                                ...
                                style={{ fontFamily: "Georgia, serif", fontStyle: "italic" }}
                            >
                                {t("pricing.titleItalic") ?? "transparent pricing."}
                            </span>
                        </h2>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    {plans.map(({ key, price, featured, index }) => (
                        <div
                            ...
                            data-pricing-card
                            className={cn(
                                "group relative border rounded-sm bg-foreground/2 p-7 md:p-8 overflow-hidden flex flex-col",
                        ...
                        >
                            ...
                            <div
                                aria-hidden
                                className="font-mono text-xs text-primary/20 tracking-[0.2em] mb-6"
                            >
                                {index}
                            </div>
                            <div className="mb-1 flex items-center justify-between">
                                ...
                                {featured && (
                                    <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-primary/45 border border-foreground/15 px-2 py-0.5 rounded-full">
                            ...
                            <div className="mt-6 mb-6 pb-6 border-b border-foreground/8">
                                <span
                                    className="font-sans font-light text-primary leading-none"
                                    style={{ fontSize: "clamp(26px, 3.2vw, 36px)", letterSpacing: "-0.03em" }}
                                >
                                    {price ?? t("pricing.customPrice")}
                                </span>
                                {price && (
                                    <span className="font-mono text-sm text-primary/35 ml-2">/month</span>
                                )}
                            </div>
...
function CtaSection() {
    ...
    const tCommon = useTranslations("serviceDetails")
    const leftRef = useReveal<HTMLDivElement>({ direction: "up", delay: 0, duration: 0.6 })
    const rightRef = useReveal<HTMLDivElement>({ direction: "up", delay: 0.12, duration: 0.6 })
                ...
                <div className="grid md:grid-cols-12 gap-4">
                    ...
                    >
                        <div className="flex items-center justify-between mb-8">
                            <p className="font-mono text-xs uppercase tracking-[0.25em] text-primary/25">
                                {t("cta.statusTitle") ?? "System Status"}
                            </p>
                            <div className="flex items-center gap-2">
                                <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                <span className="font-mono text-xs text-primary/40 tracking-[0.15em]">
                                    all systems go
                                </span>
                            </div>
                        </div>
                    ...
                    >
                        <div>
                            <p className="font-mono text-xs uppercase tracking-[0.25em] text-primary/25 mb-6 block">
                                {t("cta.eyebrow") ?? "Protect Your Site"}
                            </p>
                            <h2
