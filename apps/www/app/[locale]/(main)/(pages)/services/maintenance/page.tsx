...
function HeroSection() {
  ...
  return (
    <section
      className="maintenance-watermark relative flex w-full flex-col justify-end section-padding pb-24 overflow-hidden"
          ...
          {plans.map(({ key, price, featured, index }) => (
            ...
            >
              ...
              <div className="mt-6 mb-6 pb-6 border-b border-foreground/8">
                ...
                {price && (
                  <span className="font-mono text-sm text-primary/35 ml-2">
                    {t("pricing.perMonth")}
                  </span>
                )}
              </div>
              <ul className="flex flex-col gap-2.5 mb-8 flex-1">
                {([0, 1, 2, 3, 4] as const).map((i) => {
                  ...
                  return (
                    ...
                    >
                      <span className="font-mono text-primary/30 mt-0.5 shrink-0 select-none">
                        -
                      </span>
                      {feature}
                    </li>
        ...
        <div className="grid md:grid-cols-12 gap-4">
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <p className="font-mono text-xs uppercase tracking-[0.25em] text-muted-foreground/70">
                {t("cta.statusTitle")}
              </p>
              ...
              {checks.map((check, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-[9px] uppercase text-primary/30 tracking-[0.15em]">
                      active
                    </span>
                  </div>
                </div>
