                    ...
                    <form onSubmit={onSubmit} className="space-y-7" noValidate>
                        ...
                        <div className="grid md:grid-cols-2 gap-7">
                            ...
                            <div className="form-field">
                                ...
                                <p className="mt-1.5 font-mono text-xs text-muted-foreground/70 uppercase tracking-[0.15em]">
                        ...
                        <div className="pt-4 form-field space-y-4">
                            ...
                            <p className="text-center font-mono text-xs text-muted-foreground/70 uppercase tracking-[0.15em]">
                                {t("form.riskReversal")}
                            </p>
                            {submitSuccess && (
