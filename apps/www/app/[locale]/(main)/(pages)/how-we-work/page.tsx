            ...
            <Container>
                ...
                <section className="max-w-5xl mx-auto py-16 md:py-20">
                    <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                        ...
                        <p className="font-mono text-xs text-primary/25 uppercase tracking-[0.2em] shrink-0">
                        ...
                        {phases.map((key, i) => (
                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <span className="font-mono text-xs uppercase tracking-[0.2em] text-primary/25 pt-1">
