          ...
          {articles.map((article, i) => (
            ...
            >
              ...
              <div className="relative z-10 grid gap-6 md:grid-cols-[56px_1fr_auto] items-start">
                <span
                  className="font-mono font-light text-primary/20 group-hover:text-primary/50 transition-colors duration-300 leading-none pt-1"
                  style={{
                ...
                <div className="flex items-center gap-3 font-mono text-xs uppercase tracking-[0.15em] text-muted-foreground/70 shrink-0 pt-1">
