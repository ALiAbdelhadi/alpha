...
export async function generateStaticParams() {
    const en = (await getAllArticles("en")).map((a) => ({ locale: "en" as const, slug: a.slug }))
    const ar = (await getAllArticles("ar")).map((a) => ({ locale: "ar" as const, slug: a.slug }))
    return [...en, ...ar]
}
...
export default async function ArticlePage({ params }: ArticlePageProps) {
    ...
    const related = await getRelatedArticles(slug, article.frontmatter.tags, locale)
                    ...
                    <header className="mb-16 md:mb-20 max-w-4xl">
                        <div className="flex items-center gap-4 mb-6">
                            <time
                                ...
                                className="font-mono text-xs uppercase tracking-[0.2em] text-primary/25"
                            >
                            ...
                            <span className="font-mono text-xs uppercase tracking-[0.2em] text-primary/25">
                            ...
                            {related.map((rel) => (
                                ...
                                >
                                    <h3
                                        ...
                                        style={{ fontSize: "clamp(15px, 1.5vw, 18px)", letterSpacing: "-0.01em" }}
                                    >
