                ...
                <div className="py-12 md:py-24">
                    ...
                    <div className="grid gap-12 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
                        <div className="space-y-12">
                            {[
                                { heading: labels.challenge, content: caseStudy.problem[locale] },
                                { heading: labels.approach, content: caseStudy.solution[locale] },
                        ...
                        <aside className="space-y-4">
                            <div className="border border-foreground/8 rounded-sm bg-foreground/2 p-5">
                                <h3 className="font-mono text-xs uppercase tracking-[0.25em] text-primary/25 mb-4">
                                    {labels.techStack}
                                </h3>
                                <ul className="space-y-2">
                                    {caseStudy.techStack.map((tech) => (
                                        <li key={tech} className="flex items-center gap-3 text-sm text-primary/60">
                            ...
                            <div className="pt-2">
                                <Link
                                    ...
                                    className="group inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.18em] text-primary/40 hover:text-primary/70 transition-colors duration-300"
                                >
                                    <svg className="h-3.5 w-3.5 rtl:rotate-180 transition-transform duration-300 ltr:group-hover:-translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16l-4-4m0 0l4-4m-4 4h18" />
                                    </svg>
                                    {labels.backLink}
                                </Link>
