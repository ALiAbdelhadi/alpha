...
const WorkItem = memo(function WorkItem({ cs, index, locale }: { cs: CaseStudy, index: number, locale: "en" | "ar" }) {
    const t = useTranslations("work")
    return (
        <article>
                    ...
                    <div className="relative z-10 px-4">
                        <div className="flex items-start justify-between gap-6 mb-4">
                            <div className="flex items-baseline gap-6 md:gap-10">
                                <span
                                    className="font-mono font-light text-primary/20 group-hover:text-primary/55 transition-colors duration-300 leading-none"
                                ...
                                <div>
                                    <h2
                                        className="font-sans font-medium text-primary group-hover:translate-x-1.5 transition-transform duration-300 mb-1"
                                        style={{ fontSize: "clamp(18px, 2.5vw, 26px)", letterSpacing: "-0.015em" }}
                                    >
                                        {cs.name[locale]}
                                    </h2>
                                    <p className="font-mono text-xs uppercase tracking-[0.2em] text-primary/35">
                            ...
                            <div className="flex items-center gap-3 shrink-0">
                                ...
                                <svg
                                    className="h-4 w-4 text-primary/25 transition-all duration-300 ltr:group-hover:translate-x-1 rtl:group-hover:-translate-x-1 group-hover:text-primary/60 rtl:-rotate-180"
                        ...
                        <div className="ltr:pl-[calc(clamp(20px,2.5vw,28px)+24px)] rtl:pr-[calc(clamp(20px,2.5vw,28px)+24px)] md:ltr:pl-[calc(clamp(20px,2.5vw,28px)+40px)] md:rtl:pr-[calc(clamp(20px,2.5vw,28px)+40px)]">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="flex flex-wrap gap-2">
                                    {cs.metrics.slice(0, 2).map((metric: Metric) => (
                                        ...
                                        >
                                            <span className="font-mono text-xs uppercase tracking-[0.15em] text-primary/35">
                                                {metric.label[locale]}
                                            </span>
                                ...
                                <span className="hidden md:inline-flex items-center gap-2 font-mono text-xs text-primary/40 group-hover:text-primary/70 transition-colors duration-300">
                                    {t("viewCaseStudy")}
                                </span>
                            </div>
                        </div>
