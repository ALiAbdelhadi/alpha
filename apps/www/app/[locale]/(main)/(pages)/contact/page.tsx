                            ...
                            <div className="p-8 rounded-2xl border border-foreground/10 bg-foreground/3 backdrop-blur-md">
                                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                                    <div>
                                        ...
                                        />
                                        {formErrors.name && (
                                            <p id="contact-name-error" className="mt-1.5 flex items-center gap-1 font-mono text-xs text-red-500">
                                    ...
                                    <div>
                                        ...
                                        />
                                        {formErrors.phone && (
                                            <p id="contact-phone-error" className="mt-1.5 flex items-center gap-1 font-mono text-xs text-red-500">
                                                <AlertCircle className="h-3 w-3" aria-hidden="true" />
                                                {formErrors.phone}
                                            </p>
                                        )}
                                    ...
                                    <div>
                                        ...
                                        />
                                        {formErrors.message && (
                                            <p id="contact-message-error" className="mt-1.5 flex items-center gap-1 font-mono text-xs text-red-500">
                                                <AlertCircle className="h-3 w-3" aria-hidden="true" />
                                                {formErrors.message}
                                            </p>
                                        )}
